...
int main (int argc, char* argv[])
{
    ...
    size_t char_buffer_size = UDP_BLOCK_SIZE * 2 * 2 * 2 + SDR_PEAK_SEARCH_HEAD + SDR_SKIP_HEAD;
    ...
    while (true)
    {
        ...
        int udp_send_size = sendto (sockfd, buffer_uint16, UDP_BLOCK_SIZE * 8, 0, (struct sockaddr*) &serv_addr, slen);
