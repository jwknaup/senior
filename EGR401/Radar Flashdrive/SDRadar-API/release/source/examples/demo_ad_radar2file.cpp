// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
// Title:    SDR_API Demo - Radar Samples to File
//
// Author:   Ancortek Inc.
...
int main (int argc, char* argv[])
{
    ...
    sdr->Parameters.options.bandwidth = SDRadar::BW_200_MHz;
    ...
    size_t buffer_size = 4 * samples_per_sweep * desired_sweeps + SDR_SKIP_HEAD + SDR_PEAK_SEARCH_HEAD;
    ...
    size_t total_sweeps_collected = std::floor (((received_samples / 2.0) - skip_count) / samples_per_sweep / 2.0);
    ...
    size_t write_count = std::min (desired_sweeps, total_sweeps_collected) * samples_per_sweep * 2;

    // Start an output file
    FILE *file = std::fopen ("sdr_data.bin", "wb");
